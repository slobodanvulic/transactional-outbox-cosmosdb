using InvoicinService.Processor.Model;
using Microsoft.Azure.Functions.Worker;
using Microsoft.Extensions.Logging;
using System.Text.Json;

namespace InvoicinService.Processor.Triggers;
...
public class OrderCreatedEventHandler
{
        ...
        Connection = "ServiceBusConnectionString")] string orderCreatedEventJson)
    {
        ...
        _logger.LogInformation($"[InvoicinService] OrderCreatedEvent event received. " +
